...
use crate::{config::DNS_ID, line::{dns::LineDns, tcp2vps::LineTcp2Vps, mainland::LineMainLand, pc::LinePc, world::LineWorld}};
...
impl Gate {
    ...
    pub fn new_tcp_2_vps_line(&mut self,socket:Socket) -> u64 {
